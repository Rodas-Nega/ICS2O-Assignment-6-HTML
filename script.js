...
function pizzaOrder () {
  const size_1 = document.getElementById('large').value;
  // variable assigned to a large pizza
  const size_2 = document.getElementById('extra').value;
  // variable assigned to an extra large pizza
  const topping_1 = document.getElementById('topping1').value;
  // variable assigned to 1 topping
  const topping_2 = document.getElementById('topping2').value;
  // variable assigned to 2 toppings
  const topping_3 = document.getElementById('topping3').value;
  // variable assgined to 3 toppings
  const topping_4 = document.getElementById('topping4').value;
  // variable assigned to 4 toppings
  const menu_1 = document.getElementById('size').value;
  // variable assigned to value of the first selection box
  const menu_2 = document.getElementById('garnish').value;
  // variable assigned to value of the second selection box
  if (menu_1 == size_1 && menu_2 == topping_1) {
    alert("Subtotal = $7, Tax = $0.91, Final Cost = $7.91")  
  } else if (menu_1 == size_1 && menu_2 == topping_2) {
    alert("Subtotal = $7.75, Tax = $1.01, Final Cost = $8.76") 
  } else if (menu_1 == size_1 && menu_2 == topping_3) {
    alert("Subtotal = $8.50, Tax = $1.11, Final Cost = $9.61") 
  } else if (menu_1 == size_1 && menu_2 == topping_4) {
    alert("Subtotal = $9.35, Tax = $1.22, Final Cost = $10.57") 
  } else if (menu_1 == size_2 && menu_2 == topping_1) {
    alert("Subtotal = $11.00, Tax = $1.43, Final Cost = $12.43") 
  } else if (menu_1 == size_2 && menu_2 == topping_2) {
    alert("Subtotal = $11.75, Tax = $1.53, Final Cost = $13.28") 
  } else if (menu_1 == size_2 && menu_2 == topping_3) {
    alert("Subtotal = $12.50, Tax = $1.63, Final Cost = $14.13") 
  } else if (menu_1 == size_2 && menu_2 == topping_4) {
