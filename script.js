...
function pizzaOrder () {
  ...
  } else if (menu_One === size_Two && menu_Two === topping_One) {
    alert('Subtotal = $11.00, Tax = $1.43, Final Cost = $12.43')
  } else if (menu_One === size_Two && menu_Two === topping_Two) {
    alert('Subtotal = $11.75, Tax = $1.53, Final Cost = $13.28')
  } else if (menu_One === size_Two && menu_Two === topping_Three) {
    alert('Subtotal = $12.50, Tax = $1.63, Final Cost = $14.13')
  } else if (menu_One === size_Two && menu_Two === topping_Four) {
